...
import styles from '../styles/sportspost.module.css';
...
function SportsPost() {
    ...
    return (
        <div id={styles.pageSportPost} className="container">
            <PageHeader
            ...
            {flag ? <PacmanLoader color={"#8257E5"} size={60} css={"margin: 20rem auto;"} /> :
                <main>
                    <form onSubmit={handleCreateNews} className={styles.formSport}>
                        <fieldset className={styles.sportPost}>
